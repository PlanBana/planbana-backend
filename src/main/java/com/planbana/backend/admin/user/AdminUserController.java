...
//     public AdminUserController(AdminUserService service, AuditLogger auditLogger) {
...
//             @RequestParam(required = false) User.VerificationStatus status,
//             Authentication auth) {
...
//         Page<User> results = service.searchUsers(search, page, size, role, status);
...
//                 u.getId(),
//                 null,
//                 Map.of("email", u.getEmail(), "phone", u.getPhone()));

//         return UserDetail.from(u);
//     }

//     @PatchMapping("/{id}/roles")
//     public UserDetail updateRoles(
...
//         User updated = service.updateRoles(id, req.roles);
...
//                         "newRoles", updated.getRoles()));

//         return UserDetail.from(updated);
//     }

//     @PatchMapping("/{id}/verification")
//     public UserDetail updateVerification(
//             @PathVariable String id,
...
//         User updated = service.updateVerificationStatus(id, req.status);
...
//         User updated = service.setDisabled(id, req.disabled);
